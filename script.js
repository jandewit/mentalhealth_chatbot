...
module.exports = function() {
  return [
    ...
    { // 7
      ...
      'typing_time': 4000,
      'timing': 1,
      'text': 'Als je wilt, kun je de onderzoeker erbij halen. Laat me weten wanneer je klaar bent om te beginnen.'
    },
    { // 8
      'type': 'any',
    },
    ...
    { // 14
      ...
      'typing_time': 7000,
      'timing': 1000,
      'text': 'Ok. Zorg ervoor dat je comfortabel zit en probeer mijn instructies te volgen: Adem in... Adem uit... Adem in... Adem uit...'
    },
    { // 15
      'type': 'timed',
      'typing_time': 0,
      'timing': 2000,
      'text': '<img src="img/breathing_slow.gif" style="max-width: 200px" />'
    },
    { // 16
      'type': 'timed',
      'typing_time': 2500,
